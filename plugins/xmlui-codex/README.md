...
In non-interactive Codex runs, setup no longer auto-scaffolds by default; choose explicitly whether to scaffold (default template/path: `xmlui-weather` at `~/xmlui-weather`).
